(function () {
	...
	GameView.prototype.drawBottomHud = function () {
	  ...
	  GameView.prototype.fillCenteredText.call(this, 'SCORE: ' + this.game.player.score, Invaders.CANVAS_WIDTH / 2, 20);
	...
	GameView.prototype.fillText = function (text, x, y, color, fontSize) {
	  ...
	  if (typeof fontSize !== 'undefined') Invaders.ctx.font = fontSize + 'px Play';
